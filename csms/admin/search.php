  ...
  <form class="form-horizontal " name="search" method="post" action="" enctype="multipart/form-data">
    ...
    echo $msg;
                  ...
                  <div class="form-group">
                    <label class="col-sm-5 control-label">Search by Enquiry Number/Name/Mobile no/ Email</label>
                    <div class="col-sm-7">
...
$sdata=$_POST['searchdata'];
  ...
  <h4 align="center">Result against "<?php echo $sdata;?>" keyword </h4> 
              <table class="table">
               ...
               <?php
$ret=mysqli_query($con,"select *from  tblenquiry where EnquiryNumber like '%$sdata%' || FullName like '%$sdata%' || Email like '%$sdata%' || MobileNumber like '%$sdata%'");
