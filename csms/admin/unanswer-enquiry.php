...
if($_GET['del']){
$enqid=$_GET['id'];
mysqli_query($con,"delete from tblenquiry where ID ='$enqid'");
echo "<script>alert('Data Deleted');</script>";
echo "<script>window.location.href='unanswer-enquiry.php'</script>";
          }
...
?>
  ...
  <a href="unanswer-enquiry.php?id=<?php echo $row['ID']?>&del=delete" onClick="return confirm('Are you sure you want to delete?')" class="btn btn-danger"> Delete</a>
