...
<section class="emi-calculator section-default bg-light">
    <div class="container">
        <div class="row">
            <div class="col-12 text-center">
                <div class="ui-title-slogan">Calculate your EMI</div>
                <h2 class="ui-title">EMI Calculator</h2>
            </div>
        </div>
        <div class="row">
            <div class="col-12">
                <form id="emi-form" class="emi-form">
                    <div class="emi-form__item">
                    ...
                    <div class="emi-form__item">
                        ...
                        <input type="number" id="loan-term" name="loan-term" class="form-control" required>
                    </div>
                    <div class="emi-form__item">
                        <label for="interest-rate">Annual Interest Rate (%)</label>
                        <input type="number" id="interest-rate" name="interest-rate" class="form-control" required>
                    </div>
...
<script>
    ...
    // Event listener for EMI form submission
